...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    CSAHi Normal term=NONE cterm=NONE ctermbg=254 ctermfg=231 gui=NONE guibg=#e5e5e5 guifg=#ffffff
    ...
    CSAHi NonText term=bold cterm=bold ctermbg=188 ctermfg=153 gui=bold guibg=#cccccc guifg=#add8e6
    ...
    CSAHi CursorIM term=NONE cterm=NONE ctermbg=135 ctermfg=fg gui=NONE guibg=#a020f0 guifg=fg
    ...
    CSAHi PmenuThumb term=NONE cterm=NONE ctermbg=231 ctermfg=254 gui=reverse guibg=bg guifg=fg
    CSAHi TabLine term=underline cterm=underline ctermbg=248 ctermfg=fg gui=underline guibg=#a9a9a9 guifg=fg
    CSAHi TabLineSel term=bold cterm=bold ctermbg=bg ctermfg=fg gui=bold guibg=bg guifg=fg
    CSAHi TabLineFill term=reverse cterm=NONE ctermbg=231 ctermfg=254 gui=reverse guibg=bg guifg=fg
    ...
    CSAHi Constant term=underline cterm=NONE ctermbg=255 ctermfg=217 gui=NONE guibg=#f2f2f2 guifg=#ffa0a0
    CSAHi Special term=bold cterm=NONE ctermbg=255 ctermfg=223 gui=NONE guibg=#f2f2f2 guifg=#ffdead
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    CSAHi Normal term=NONE cterm=NONE ctermbg=254 ctermfg=255 gui=NONE guibg=#e5e5e5 guifg=#ffffff
    ...
    CSAHi NonText term=bold cterm=bold ctermbg=252 ctermfg=195 gui=bold guibg=#cccccc guifg=#add8e6
    CSAHi Directory term=bold cterm=NONE ctermbg=bg ctermfg=51 gui=NONE guibg=bg guifg=#00ffff
    ...
    CSAHi LineNr term=underline cterm=NONE ctermbg=bg ctermfg=226 gui=NONE guibg=bg guifg=#ffff00
    CSAHi CursorIM term=NONE cterm=NONE ctermbg=171 ctermfg=fg gui=NONE guibg=#a020f0 guifg=fg
    CSAHi ZenkakuSpace term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi EasyMotionTargetDefault term=NONE cterm=bold ctermbg=bg ctermfg=196 gui=bold guibg=bg guifg=#ff0000
    CSAHi EasyMotionShadeDefault term=NONE cterm=NONE ctermbg=bg ctermfg=243 gui=NONE guibg=bg guifg=#777777
    CSAHi SpellLocal term=underline cterm=undercurl ctermbg=bg ctermfg=51 gui=undercurl guibg=bg guifg=fg guisp=#00ffff
    ...
    CSAHi PmenuSel term=NONE cterm=NONE ctermbg=248 ctermfg=fg gui=NONE guibg=#a9a9a9 guifg=fg
    CSAHi PmenuSbar term=NONE cterm=NONE ctermbg=250 ctermfg=fg gui=NONE guibg=#bebebe guifg=fg
    CSAHi PmenuThumb term=NONE cterm=NONE ctermbg=255 ctermfg=254 gui=reverse guibg=bg guifg=fg
    CSAHi TabLine term=underline cterm=underline ctermbg=248 ctermfg=fg gui=underline guibg=#a9a9a9 guifg=fg
    CSAHi TabLineSel term=bold cterm=bold ctermbg=bg ctermfg=fg gui=bold guibg=bg guifg=fg
    CSAHi TabLineFill term=reverse cterm=NONE ctermbg=255 ctermfg=254 gui=reverse guibg=bg guifg=fg
    ...
    CSAHi Constant term=underline cterm=NONE ctermbg=255 ctermfg=224 gui=NONE guibg=#f2f2f2 guifg=#ffa0a0
    CSAHi Special term=bold cterm=NONE ctermbg=255 ctermfg=230 gui=NONE guibg=#f2f2f2 guifg=#ffdead
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi NonText term=bold cterm=bold ctermbg=252 ctermfg=152 gui=bold guibg=#cccccc guifg=#add8e6
    CSAHi Directory term=bold cterm=NONE ctermbg=bg ctermfg=51 gui=NONE guibg=bg guifg=#00ffff
    CSAHi ErrorMsg term=NONE cterm=NONE ctermbg=196 ctermfg=231 gui=NONE guibg=#ff0000 guifg=#ffffff
    ...
    CSAHi LineNr term=underline cterm=NONE ctermbg=bg ctermfg=226 gui=NONE guibg=bg guifg=#ffff00
    CSAHi CursorIM term=NONE cterm=NONE ctermbg=129 ctermfg=fg gui=NONE guibg=#a020f0 guifg=fg
    CSAHi ZenkakuSpace term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi EasyMotionTargetDefault term=NONE cterm=bold ctermbg=bg ctermfg=196 gui=bold guibg=bg guifg=#ff0000
    CSAHi EasyMotionShadeDefault term=NONE cterm=NONE ctermbg=bg ctermfg=243 gui=NONE guibg=bg guifg=#777777
    CSAHi SpellLocal term=underline cterm=undercurl ctermbg=bg ctermfg=51 gui=undercurl guibg=bg guifg=fg guisp=#00ffff
...
elseif has("gui_running") || &t_Co == 88
    CSAHi Normal term=NONE cterm=NONE ctermbg=87 ctermfg=79 gui=NONE guibg=#e5e5e5 guifg=#ffffff
    ...
    CSAHi NonText term=bold cterm=bold ctermbg=58 ctermfg=58 gui=bold guibg=#cccccc guifg=#add8e6
    ...
    CSAHi CursorIM term=NONE cterm=NONE ctermbg=35 ctermfg=fg gui=NONE guibg=#a020f0 guifg=fg
    CSAHi ZenkakuSpace term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi PmenuThumb term=NONE cterm=NONE ctermbg=79 ctermfg=87 gui=reverse guibg=bg guifg=fg
    CSAHi TabLine term=underline cterm=underline ctermbg=84 ctermfg=fg gui=underline guibg=#a9a9a9 guifg=fg
    CSAHi TabLineSel term=bold cterm=bold ctermbg=bg ctermfg=fg gui=bold guibg=bg guifg=fg
    CSAHi TabLineFill term=reverse cterm=NONE ctermbg=79 ctermfg=87 gui=reverse guibg=bg guifg=fg
    ...
    CSAHi Constant term=underline cterm=NONE ctermbg=87 ctermfg=69 gui=NONE guibg=#f2f2f2 guifg=#ffa0a0
    CSAHi Special term=bold cterm=NONE ctermbg=87 ctermfg=74 gui=NONE guibg=#f2f2f2 guifg=#ffdead
